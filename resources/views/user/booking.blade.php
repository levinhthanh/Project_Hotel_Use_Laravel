        ...
        <div class="container-fluid w-50" id="contentBooking">
            ...
            <form action="{{ route('check_rooms') }}" method="post">
                ...
                <table class="table">
                    ...
                    <tr>
                        <input name="checkIn" id="dayIn" onchange="checkDayIn(this.value)"
                            class="form-control input-group pl-3" type="date" value="{{ $checkIn }}" required>
                    </tr>
                    <tr>
                        <p class="container h4 mt-5">2. CHỌN NGÀY ĐI</p>
                    </tr>
                    <tr>
                        <input name="checkOut" id="dayOut" onchange="checkDayOut(this.value)"
                            class="form-control input-group pl-3" type="date" value="{{ $checkOut }}" required>
                    </tr>
                    <tr class="">
