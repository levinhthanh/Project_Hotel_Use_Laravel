...
@section('title', 'Quản lý trả phòng')
...
@section('title_content', 'Danh sách nhận phòng')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="row justify-content-center" id="repay_confirm">
...
@push('scripts')
    <script src="{{ asset('js/repay.js') }}"></script>
@endpush
